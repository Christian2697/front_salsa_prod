...
import ReservPersonList from './ReservPersonList';
...
class ReservPerson extends Component {

    state = {
        estado: 0,
        titleAdmin: 'Reservaciones Personales',
        searchParams: '',
        reservation: {},
        url: config.urlBack,
        isDarkMode: true,
    ...
    fetchList = async () => {
        ...
        console.log('Datos a enviar al Back: ', data);
        try {
            const response = await fetch(`${url}/admin/reserv/list-qr`, {
                method: 'POST',
                body: JSON.stringify(data),
                headers: {
                    'Content-Type': 'application/json'
                ...
                <Container sx={{
                    ...
                    >
                        ...
                        {estado === 1
                            ...
                            <Container sx={{
                                width: '100%',
                                maxWidth: { xs: '100%', sm: '99%', md: '99%', lg: '99%' },
                                my: 2,
